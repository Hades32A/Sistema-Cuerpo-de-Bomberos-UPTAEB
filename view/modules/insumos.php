...
<section class="module module--insumos insumos">
    ...
    <form method="POST" action="?url=insumos" class="module-search" style="margin-bottom: 1rem; display: flex; gap: 8px; flex-wrap: wrap;">
        <input type="text" name="buscar" class="module-search__input" placeholder="Buscar por nombre o código..." value="<?= htmlspecialchars($busqueda); ?>" style="flex:1;min-width:220px;padding:0.5rem 0.75rem;border:1px solid #e2e8f0;border-radius:0.5rem;">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="insumos-table__actions">
                                    <a href="?url=insumos&amp;editar=<?= (int) ($insumo['id_insumo'] ?? 0); ?>" class="insumos-table__action">Editar</a>
                                    <form method="POST" action="?url=insumos" style="display:inline;" onsubmit="return confirm('¿Eliminar este insumo?');">
...
<div class="modal<?= $esEdicion ? ' is-open' : ''; ?>" id="modal-insumos" aria-hidden="<?= $esEdicion ? 'false' : 'true'; ?>">
    ...
    <div class="modal__dialog" role="dialog">
        ...
        <form method="POST" action="?url=insumos" class="modal__form">
