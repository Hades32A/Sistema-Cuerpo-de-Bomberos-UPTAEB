...
<section class="module module--personal">
    ...
    <form method="POST" action="?url=personal" class="module-search" style="margin-bottom: 1rem; display: flex; gap: 8px; flex-wrap: wrap;">
        <input type="text" name="buscar" class="module-search__input" placeholder="Buscar por nombre, apellido o cédula..." value="<?= htmlspecialchars($busqueda); ?>" style="flex:1;min-width:220px;padding:0.5rem 0.75rem;border:1px solid #e2e8f0;border-radius:0.5rem;">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="insumos-table__actions">
                                    <a href="?url=personal&amp;editar=<?= (int) ($bombero['id_personal'] ?? 0); ?>" class="insumos-table__action">Editar</a>
                                    <form method="POST" action="?url=personal" style="display:inline;" onsubmit="return confirm('¿Eliminar este registro de personal?');">
...
<div class="modal<?= $esEdicion ? ' is-open' : ''; ?>" id="modal-personal" aria-hidden="<?= $esEdicion ? 'false' : 'true'; ?>">
    ...
    <div class="modal__dialog" role="dialog" aria-labelledby="modal-personal-title">
        ...
        <form method="POST" action="?url=personal" class="modal__form">
