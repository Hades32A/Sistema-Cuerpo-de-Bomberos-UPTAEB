...
<section class="module module--personal">
    ...
    <form method="GET" action="<?= htmlspecialchars(app_url('personal'), ENT_QUOTES, 'UTF-8') ?>" class="module-search" style="margin-bottom: 1rem; display: flex; gap: 8px; flex-wrap: wrap;">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="insumos-table__actions">
                                    <a href="<?= htmlspecialchars(app_url('personal', array('editar' => (int) ($bombero['id_personal'] ?? 0), 'busqueda' => $busqueda !== '' ? $busqueda : null)), ENT_QUOTES, 'UTF-8') ?>" class="insumos-table__action">Editar</a>
                                    <form method="POST" action="<?= htmlspecialchars(app_url('personal'), ENT_QUOTES, 'UTF-8') ?>" style="display:inline;" onsubmit="return confirm('¿Eliminar este registro de personal?');">
...
<div class="modal<?= $esEdicion ? ' is-open' : ''; ?>" id="modal-personal" aria-hidden="<?= $esEdicion ? 'false' : 'true'; ?>">
    ...
    <div class="modal__dialog" role="dialog" aria-labelledby="modal-personal-title">
        ...
        <form method="POST" action="<?= htmlspecialchars(app_url('personal'), ENT_QUOTES, 'UTF-8') ?>" class="modal__form">
