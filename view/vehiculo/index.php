...
<section class="module module--vehiculos">
    ...
    <form method="GET" action="<?= htmlspecialchars(app_url('vehiculo'), ENT_QUOTES, 'UTF-8') ?>" class="module-search" style="margin-bottom: 1rem; display: flex; gap: 8px; flex-wrap: wrap;">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="insumos-table__actions">
                                    <a href="<?= htmlspecialchars(app_url('vehiculo', array('editar' => (string) ($unidad['id_vehiculo'] ?? ''))), ENT_QUOTES, 'UTF-8') ?>" class="insumos-table__action">Editar</a>
                                    <form method="POST" action="<?= htmlspecialchars(app_url('vehiculo'), ENT_QUOTES, 'UTF-8') ?>" style="display:inline;" onsubmit="return confirm('¿Eliminar este vehículo?');">
...
<div class="modal<?= $esEdicion ? ' is-open' : ''; ?>" id="modal-vehiculos" aria-hidden="<?= $esEdicion ? 'false' : 'true'; ?>">
    ...
    <div class="modal__dialog" role="dialog">
        ...
        <form method="POST" action="<?= htmlspecialchars(app_url('vehiculo'), ENT_QUOTES, 'UTF-8') ?>" class="modal__form">
