...
class Paciente extends Model
{
    ...
    public function obtenerPrimeraCedula()
    {
    ...
    public function obtenerUltimaEmergenciaId()
    {
        $stmt = $this->db->query('SELECT Id_llamadas FROM llamada ORDER BY Id_llamadas DESC LIMIT 1');
        $id = $stmt->fetchColumn();
