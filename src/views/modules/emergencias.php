...
<section class="module module--emergencias">
    ...
    <form method="GET" class="module-search" style="margin-bottom: 1rem; display: flex; gap: 8px; flex-wrap: wrap;">
        <input type="hidden" name="modulo" value="emergencias">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="insumos-table__actions">
                                    <a href="index.php?modulo=emergencias&amp;editar=<?= (int) ($incidente['id_emergencia'] ?? 0); ?>" class="insumos-table__action">Editar</a>
                                    <form method="POST" style="display:inline;" onsubmit="return confirm('¿Eliminar esta emergencia?');">
                                        <input type="hidden" name="modulo" value="emergencias"><input type="hidden" name="accion" value="eliminar">
