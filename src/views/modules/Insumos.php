...
<section class="module module--insumos insumos">
    ...
    <form method="GET" class="module-search" style="margin-bottom: 1rem; display: flex; gap: 8px; flex-wrap: wrap;">
        <input type="hidden" name="modulo" value="insumos">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="insumos-table__actions">
                                    <a href="index.php?modulo=insumos&amp;editar=<?= (int) ($insumo['id_insumo'] ?? 0); ?><?= $busqueda !== '' ? '&amp;busqueda=' . urlencode($busqueda) : ''; ?>" class="insumos-table__action">Editar</a>
