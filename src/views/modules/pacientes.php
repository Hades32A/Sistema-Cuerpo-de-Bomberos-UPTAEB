...
<section class="module module--pacientes">
    ...
    <form method="GET" class="module-search" style="margin-bottom: 1rem; display: flex; gap: 8px; flex-wrap: wrap;">
        <input type="hidden" name="modulo" value="pacientes">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="insumos-table__actions">
                                    <a href="index.php?modulo=pacientes&amp;editar=<?= (int) ($paciente['id_paciente'] ?? 0); ?>" class="insumos-table__action">Editar</a>
                                    <form method="POST" style="display:inline;" onsubmit="return confirm('¿Eliminar este paciente?');">
                                        <input type="hidden" name="modulo" value="pacientes"><input type="hidden" name="accion" value="eliminar">
